...
public class GetGuideNameData implements  Parcelable
{
    ...
    public final static Parcelable.Creator<GetGuideNameData> CREATOR = new Creator<GetGuideNameData>() {


        @SuppressWarnings({
                "unchecked"
        })
        public GetGuideNameData createFromParcel(Parcel in) {
            return new GetGuideNameData(in);
        }

        public GetGuideNameData[] newArray(int size) {
            return (new GetGuideNameData[size]);
        }
    ...
    protected GetGuideNameData(Parcel in) {
